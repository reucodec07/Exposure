...
const ADMIN_PASSWORD =
  process.env.NEXT_PUBLIC_ADMIN_PASS || "yourStrongPassword";
...
function AdminPageContent() {
  ...
  if (!mounted) {
    return (
      <div className="text-center text-xl text-gray-500 mt-40">Loading…</div>
    );
  }

  if (secretKey !== ADMIN_KEY) {
    return (
      <div className="text-center text-xl text-gray-500 mt-40">Not found.</div>
    );
  }
  ...
  return (
    <section
      id="admin"
      className="max-w-xl mx-auto mt-20 bg-white rounded-2xl shadow p-8"
    >
      {!isLoggedIn ? (
