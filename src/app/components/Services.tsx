...
const services = [
    ...
    },
    {
        ...
        description: "Weather-resistant boards illuminated from the front. Ideal for keeping your message clear and visible in any outdoor setting.",
        icon: FaLightbulb,
        category: "Outdoor"
    },
    {
    ...
    },
    {
        ...
        description: "Take your message anywhere! Custom fabrication for vehicle-mounted hoardings and moving displays, built tough for the road.",
        icon: FaRocket,
        category: "Mobile"
    },
    {
...
export default function Services() {
    ...
    const categories = ["All", "Digital", "Illuminated", "Custom", "Outdoor", "Indoor", "Exterior", "Mobile", "Premium", "Dynamic"];
                ...
                <div className="services-filters">
                    {categories.map((category) => (
                        <button
                            ...
                            className={`services-filter ${activeCategory === category ? 'active' : ''}`}
                        >
                            <span>{category}</span>
                        ...
                        <div key={index} className="service-card">
                            ...
                            <div className="service-content">
                                ...
                                >
                                    ...
                                    <FaChevronDown
                                        className={`service-toggle-icon ${openIdx === index ? 'rotated' : ''}`}
                                    />
                                </button>

                                {/* Expanded Content */}
                                <div className={`service-details ${openIdx === index ? 'expanded' : ''}`}>
