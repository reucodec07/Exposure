            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    ...
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
                        <span className="text-blue-600 block">Capturing Memories</span>
                ...
                <div className="block lg:grid lg:grid-cols-2 lg:gap-16 mb-12 sm:mb-16">
                    ...
                    <div className="mb-8 lg:mb-0">
                        <div className="mb-6 sm:mb-8">
                            <p className="text-slate-600 leading-relaxed text-base sm:text-lg">
                                <span className="text-blue-600 font-bold text-lg sm:text-xl">Exposure</span> is
                                your trusted expert in professional photography, capturing stunning images that tell your
                                story beautifully.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Years of experience capturing beautiful weddings, stunning portraits, and professional commercial shots"
                                },
                                {
                                    title: "High-End Equipment:",
                                    desc: "State-of-the-art cameras and lighting technology for pixel-perfect results"
                                },
                                {
                                    title: "Complete Coverage:",
                                    desc: "From creative planning to fast editing and high-resolution delivery"
                                },
                            ].map((feature, index) => (
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                            <p className="text-blue-800 font-medium italic text-base sm:text-lg text-center">
                                &#34;No moment is too small – we capture your story beautifully!&#34;
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                        {[
                            { number: "500+", label: "Shoots Completed", icon: FaChartLine, color: "text-green-600" },
                            { number: "4K", label: "Resolution Delivered", icon: FaStar, color: "text-yellow-600" },
                ...
                <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 mb-12 sm:mb-16">
                    <div className="flex items-center justify-center mb-6 sm:mb-8">
                        ...
                        <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-800">Why Choose Exposure?</h3>
                    </div>

                    <div className="max-w-4xl mx-auto">
                        <div className="grid md:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                            {[
                                "Free consultation & shoot planning to bring your vision to life",
                                "Competitive pricing with no hidden costs – transparent packages",
                                "Fast turnaround time (5-7 days) for high-resolution edited photos",
                                "Professional shooting by our experienced photography team",
                                "Secure backup of your precious memories with dedicated support",
                            ].map((item, index) => (
                ...
                <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8">
                    {[
                        { text: "Professional Gear", icon: FaShieldAlt, color: "text-green-600" },
                        { text: "Fast Editing", icon: FaClock, color: "text-blue-600" },
